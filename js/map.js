...
class Map {
    ...
    drawMap(world) {
        ...
        let geoPath = d3.geoPath(this.projection);
        ...
        let svgMap = d3.select("#map-chart").append("svg");
        ...
        svgMap.append("path")
            .datum(graticule).attr("class","graticule").attr("d",geoPath);
        svgMap.append("path")
            .datum(graticule.outline).attr("class", "graticule outline").attr("d", geoPath);
    }
